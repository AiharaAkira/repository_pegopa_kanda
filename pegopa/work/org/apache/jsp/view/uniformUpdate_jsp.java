 ...
 * Generated at: 2023-06-28 00:24:33 UTC
...
public final class uniformUpdate_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Uniform uniform = (Uniform)request.getAttribute("uniform"); 
      ...
      out.write("\t\t\t\t\t<td align=\"center\"><a href=\"");
      out.print(request.getContextPath() );
      out.write("/uniformList\" style=\"text-decoration:none;\">【商品一覧】</a></td>\r\n");
      out.write("\t\t\t\t\t<td align=\"center\"><a href=\"");
      out.print(request.getContextPath() );
      out.write("/orderHistory\" style=\"text-decoration:none;\">【受注状況一覧】</a></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t\t<hr color=\"black\" width=\"90%\"></hr>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t");
if(uniform.getName()==null){ 
      out.write("\r\n");
      out.write("\t<!-- データベースにないデータで入った時 -->\r\n");
      out.write("\r\n");
      out.write("\t\t\t<h3 style=\"text-align: center; color: gray;\">商品が見つかりません。</h3>\r\n");
      out.write("\t\t\t<div align = \"center\">\r\n");
      out.write("\t\t\t<a style=\"display: inline-block; margin-top: 50px; border: 1px solid black; border-radius: 4px; padding: 4px 8px; cursor: pointer; color: black; text-decoration: none;\"  href = \"");
      out.print(request.getContextPath() );
      out.write("/uniformList\">戻る</a>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t");
}else{ 
      out.write("\r\n");
      out.write("\t<!-- 正常ルート -->\r\n");
      out.write("\t\t\t<h2 style=\"padding-top:20px;\" align = \"center\">商品情報詳細</h2>\r\n");
      out.write("\r\n");
      out.write("\t\t\t<form action=\"");
      out.print(request.getContextPath() );
      out.write("/uniformUpdate\" method=\"post\" enctype=\"multipart/form-data\" onsubmit=\"return call();\">\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"id\" value=\"");
      out.print(uniform.getId() );
      out.write("\">\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"img_original\" value=\"");
      out.print(uniform.getImg() );
      out.write("\">\r\n");
      out.write("\t\t\t<table cellpadding=\"8\" style=\"padding-top:30px; padding-bottom:20px; text-align:left;\">\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<th bgcolor=\"#66CC99\" width=\"130\">商品No</th>\r\n");
      out.write("\t\t\t\t\t<td width=\"130\">");
      out.print(uniform.getId() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<th bgcolor=\"#66CC99\" width=\"130\">種類</th>\r\n");
      out.write("\t\t\t\t\t<td><input id=\"name\" type=text size=\"25\" name=\"name\" value=\"");
      out.print(uniform.getName());
      out.write("\"></input></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<th bgcolor=\"#66CC99\" width=\"130\">単価</th>\r\n");
      out.write("\t\t\t\t\t<td><input id=\"price\" type=text size=\"25\" name=\"price\" value=\"");
      ...
      out.print(uniform.getImg() );
      out.write("\" alt=\"img\" width=\"70\" height=\"70\">\r\n");
      out.write("\t\t\t\t\t<input id=\"file\" type=file size=\"25\" name=\"img\" ></input></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>&nbsp;</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t<td style=\"padding-top:0px; padding-bottom:0px;\"><input id=\"stock\" type=\"text\" name=\"stock\" value=\"");
      out.print(uniform.getStock() );
      out.write("\" style=\"height:50px; width:150px;\"></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t\t<div style=\"display: flex; justify-content: space-between; align-items: center; width: 150px;\">\r\n");
      out.write("\t\t\t\t<input style=\"background: none; border: 1px solid black; border-radius: 4px; padding: 2px 6px;\" type=\"submit\" value=\"変更\">\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t\t<form action=\"");
      out.print(request.getContextPath() );
      out.write("/uniformUpdate\">\r\n");
      out.write("\t\t\t\t<input type=\"hidden\" name=\"cmd\" value=\"3\">\r\n");
      out.write("\t\t\t\t<input type=\"hidden\" name=\"id\" value=\"");
      out.print(uniform.getId() );
      out.write("\">\r\n");
      out.write("\t\t\t\t<input style=\"background: none; border: 1px solid black; border-radius: 4px; padding: 2px 6px;\" type=\"submit\" value=\"削除\">\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\r\n");
